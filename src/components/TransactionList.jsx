  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <a href="#" className="text-indigo-600 hover:underline">Show All</a>
      </div>
      <ul className="space-y-4">
        <li className="flex items-center">
          <i className="fas fa-exchange-alt text-gray-500 text-lg"></i>
          <div className="ml-3">
            <p className="text-gray-800 font-semibold">Joylaggah</p>
        ...
        <li className="flex items-center">
          <i className="fas fa-exchange-alt text-gray-500 text-lg"></i>
          <div className="ml-3">
            <p className="text-gray-800 font-semibold">Wallet operation</p>
